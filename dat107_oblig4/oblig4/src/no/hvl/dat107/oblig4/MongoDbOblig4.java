...
public class MongoDbOblig4 {
    public static void main(String[] args) throws IOException {
        ...
        MongoClient client = MongoClientFactory.getMongoClient( "mongodb://localhost:674919");
        ...
        repoLoad.loadCollection("kunde", "oblig4/data/kunde.json");
        repoLoad.loadCollection("vare", "oblig4/data/vare.json");
        repoLoad.loadCollection("ordre", "oblig4/data/ordre.json");
